...
- To facilitate this, we have raw data available from different sources which are listed below. Using these we will transform and create a datalake in S3 using pyspark and then load them to tables in Redshift which can be queried to do analysis such as:
